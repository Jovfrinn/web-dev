...
<div class="sidebar">
    ...
    <a href="{{ route('category-biskuit') }}">Roti/Biskuit</a>
    <a class="active" {{ Route::currentRouteName() == 'category-instan' ? 'active' : '' }} href="{{ route('category-instan') }}">Makanan Instan</a>
    <a href="{{ route('category-manis') }}">Makanan Manis</a>
  </div>

<div class="container">
    <div class="content">
        <div class="title-content">Makanan Instan</div>
