...
<div class="sidebar">
    <a class="active" {{ Route::currentRouteName() == 'category-air-mineral' ? 'active' : '' }} href="{{ route('category-air-mineral') }}">Minuman Air Mineral</a>
...
<div class="container">
    <div class="content">
        <div class="title-content">Air Mineral</div>
