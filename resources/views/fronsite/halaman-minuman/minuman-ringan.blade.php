...
<div class="sidebar">
    ...
    <a href="{{ route('category-kopi') }}">Minuman Kopi</a>
    <a class="active" {{ Route::currentRouteName() == 'category-minuman-ringan' ? 'active' : '' }} href="{{ route('category-minuman-ringan') }}">Minuman Ringan</a>
...
<div class="container">
    <div class="content">
        <div class="title-content">Minuman Ringan</div>
